# Second-round audit — 2026-05-15T16:52:06.092205Z
...
```json
{
  "capsule_root": "/var/folders/7t/n4yt9y_n1pb9dcrdxrltwqfw0000gn/T/audit2_capsule_f58le_cd",
  "crispr_cas9": {
    "abstract_len": 997,
    "cited_by_count": 17089,
...
```json
{
  "alphafold_readme": {
    ...
    "chunk_count": 11,
    "status": "ok",
    "first_chunk_preview": "![header](imgs/header.jpg)\n\n# AlphaFold\n\nThis package provides an implementation"
  },
  "transformers_root_readme": {
    "body_len": 17919,
    "chunk_count": 6,
    "status": "ok",
